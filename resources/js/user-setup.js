	...
	try {
		...
		$('#enable-notifications').click(function() {
		  ...
		  messaging.getToken()
		    ...
		    .catch(function() {
		    	const retry = confirm("There was a problem enabling notifications on your device. Would you like to retry?");
		    	if (retry) {
		...
		$('.alert').text("Sorry. But your device doesn't support notifications. Click the finish setup button to finish account setup.")
			.removeClass('alert-info')
			.addClass('alert-warning');
		alert("Sorry. But your device doesn't support notifications. Click the finish setup button to finish account setup.")
	}
}
